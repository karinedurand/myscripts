...
rbind.na(SI1,SI2 ,IM1,IM2,IM3,IM4,SC1,SC2,SC3,SC4,AM1,AM2,AM3,AM4)->sumstatN10000
...
```{r}
N1 <- rouxN10000$param$N1[modindex == "AM3"]
dataN1 <- data.frame(N1, sumstatN10000)
dataN1 <-dataN1[120001:130000,]
...
dev.off()
N2 <- rouxN10000$param$N2[modindex == "AM3"]
dataN2 <- data.frame(N2, sumstatN10000)
dataN2 <-dataN2[120001:130000,]
...
dev.off()
####
TS <-  rouxN10000$param$Tsplit[modindex == "IM3"]
dataTS <- data.frame(TS, sumstatN10000)
dataTS  <-dataTS[120001:130000,]
...
dev.off()
##
M1<-  rouxN10000$param$M1[modindex == "AM3"]
dataM1 <- data.frame(M1, sumstatN10000)
dataM1   <-dataM1[120001:130000,]
...
dev.off()
M2<-  rouxN10000$param$M2[modindex == "AM3"]
dataM2 <- data.frame(M2, sumstatN10000)
dataM2   <-dataM2[120001:130000,]
...
dev.off()
####TAM
TAM <-  rouxN10000$param$Tam[modindex == "AM3"]
dataTAM <- data.frame(TAM, sumstatN10000)
dataTAM  <-dataTAM[120001:130000,]

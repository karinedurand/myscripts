...
```{r cars}
###ormule#############
paramSI1 <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/thetaN10000/SI_NhomoN10000/priorfile", col_names = T)
...
paramIM1 <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/thetaN10000/SC_Nhomo_Mhomo_N10000/priorfile", col_names = T)
...
paramSC1<- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/thetaN10000/SC_Nhomo_Mhomo_N10000/priorfile", col_names = T)
...
paramAM1<- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/thetaN10000/AM_Nhomo_Mhomo_N10000/priorfile", col_names = T)
...
SI1 <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/thetaN10000/SI_NhomoN10000/ABCstat.txt", col_names = T)
...
SC1 <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/thetaN10000/SC_Nhomo_Mhomo_N10000/ABCstat.txt",  col_names = T)
...
IM1 <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/thetaN10000/IM_Nhomo_Mhomo_N10000//ABCstat.txt",  col_names = T)
...
AM1 <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/thetaN10000/AM_Nhomo_Mhomo_N10000//ABCstat.txt",  col_names = T)
...
M1<-  rouxN3000$param$M1[modindex == "AM1"]

dataM1 <- data.frame(M1, sumstatN3000)

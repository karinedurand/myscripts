...
```{r cars}
###ormule#############
paramSIhomo <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/theta_N3000/SI_NhomoN3000/priorfile", col_names = T)
...
paramIM1 <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/theta_N3000/IM_Nhomo_Mhomo_N3000/priorfile", col_names = T)
...
paramSC1<- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/theta_N3000/SC_Nhomo_Mhomo_N3000//priorfile", col_names = T)
...
paramAM1<- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/theta_N3000/AM_Nhomo_Mhomo_N3000//priorfile", col_names = T)
...
SINhomo <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/theta_N3000/SI_NhomoN3000//ABCstat.txt", col_names = T)
...
SC1 <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/theta_N3000/SC_Nhomo_Mhomo_N3000//ABCstat.txt",  col_names = T)
...
IM1 <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/theta_N3000/IM_Nhomo_Mhomo_N3000/ABCstat.txt",  col_names = T)
...
AM1 <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/theta_N3000/AM_Nhomo_Mhomo_N3000/ABCstat.txt",  col_names = T)
...
rouxN3000 <- list(modindex=modindex,param=dfparam, sumsta=dfsumsta)
dataN3000 <- data.frame(modindex, sumstatRoux)
model.rf1ROUX<- abcrf(modindex~., data=dataN3000 ,ntree=500,paral = TRUE)
model.rf1ROUX
...
#aec les data obs
plot(model.rf1ROUX, dataN100, obs=obs997[1,])
...
dev.off()
####
TS <-   rouxN3000$param$Tsplit[modindex == "AM1"]

...
#rbind.fill(paramSI1,paramSI1asym,paramSI2,paramSI2asym,paramIM1,paramIM1asym,paramIM2,paramIM3,paramIM3asym,paramIM4,paramSC1,paramSC1asym,paramSC2,paramSC3,paramSC3asym,paramSC4,paramAM1,paramAM1asym,paramAM2,paramAM3,paramAM3asym,paramAM4)->param13paucamulti
rbind.fill(paramSI1,paramSI2,paramIM1,paramIM3,paramSC1,paramSC3,paramAM1,paramAM3)->param13paucamulti
...
#rbind.na(SI1,SI1asym,SI2 ,SI2asym,IM1,IM1asym,IM2,IM3,IM3asym ,IM4,SC1,SC1asym ,SC2,SC3,SC3asym,SC4,AM1,AM1asym ,AM2,AM3,AM3asym ,AM4)->sumstat13paucamulti
rbind.na(SI1,SI2 ,IM1,IM3,SC1,SC3,AM1,AM3)->sumstat13paucamulti
...
modindex <- as.factor(c(rep("SIhomo",10000),c(rep("SIhomo_asym",10000),rep("SIhetero",10000),rep("SIhetero_asym",10000),rep("IM1",10000),rep("IM1_asym",10000),rep("IM2",10000),rep("IM3",10000),rep("IM3_asym",10000),rep("IM4",10000), rep("SC1",10000),rep("SC1_asym",10000), rep("SC2",10000), rep("SC3",10000), rep("SC3_asym",10000), rep("SC4",10000),rep("AM1",10000),rep("AM1_asym",10000),rep("AM2",10000),rep("AM3",10000),rep("AM3_asym",10000),rep("AM4",10000))))

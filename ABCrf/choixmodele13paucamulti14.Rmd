...
SC3 <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti3/SC_Nhetero_Mhomo/ABCstat.txt",  col_names = T)
...
IM2 <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti3/IM_Nhomo_Mhetero/ABCstat.txt",  col_names = T)
...
IM4 <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti3/IM_Nhetero_Mhetero/ABCstat.txt",  col_names = T)
...
rbind.na(SI1,SI2 ,IM1,SC1,AM1)->sumstatN10000
...
predict(model.rf1ROUX, obs1169, dataN10000, ntree=500)
...
#aec les data obs
plot(model.rf1ROUX, dataN10000, obs=obs1169[1,])
...
```{r}
N1 <- rouxN10000$param$N1[modindex == "SI2"]
dataN1 <- data.frame(N1, sumstatN10000)
dataN1 <-dataN1[1:50000,]
...
dev.off()
N2 <- rouxN10000$param$N2[modindex == "AM4"]
...
dev.off()
####
TS <-  rouxN10000$param$Tsplit[modindex == "SI2"]
...
dev.off()
##
M1<-  rouxN10000$param$M1[modindex == "IM1"]
dataM1 <- data.frame(M1, sumstatN10000)
dataM1   <-dataM1[20001:30000,]

...
```{r cars}
###ormule#############
paramSIhomo <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/theta_N100/SI_NhomoN100/priorfile", col_names = T)
...
paramIM1 <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/theta_beast/IM_Nhomo_Mhomo/priorfile", col_names = T)
...
paramSC1<- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/theta_beast/SC_Nhomo_Mhomo/priorfile", col_names = T)
...
paramAM1<- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/theta_N100/AM_Nhomo_Mhomo/priorfile", col_names = T)
...
SINhomo <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/theta_N100/SI_NhomoN100/ABCstat.txt", col_names = T)
...
SC1 <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/theta_beast/SC_Nhomo_Mhomo/ABCstat.txt",  col_names = T)
...
IM1 <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/theta_beast/IM_Nhomo_Mhomo/ABCstat.txt",  col_names = T)
...
AM1 <- read_table2("~/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/theta_N100/AM_Nhomo_Mhomo/ABCstat.txt",  col_names = T)
...
modindex <- as.factor(c(rep("SIhomo",986),rep("IM1",986)  , rep("SC1",986),rep("AM1",986)))
...
model.rf1ROUX<- abcrf(modindex~., data=data1 ,ntree=500,paral = TRUE)
model.rf1ROUX
plot(model.rf1ROUX)
...
dev.off()
####
TS <-  XROUX $param$Tsplit[modindex == "SINhomo"]

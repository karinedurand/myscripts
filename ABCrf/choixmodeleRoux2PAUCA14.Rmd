...
rbind.na(SI1,SINhetero ,IM1,IM2,IM3,IM4,SC1,SC2,SC3,SC4,AM1,AM2,AM3,AM4)->sumstat2popspauca
...
```{r}
N1 <- rouxN10000$param$N1[modindex == "AM4"]
...
dev.off()
####
TS <-  rouxN10000$param$Tsplit[modindex == "AM4"]
...
dev.off()
##
M1<-  rouxN10000$param$M1[modindex == "AM4"]
...
dev.off()
M2<-  rouxN10000$param$M2[modindex == "AM4"]

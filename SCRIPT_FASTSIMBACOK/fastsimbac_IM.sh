...
echo ./fastSimBac 30 $L -T -t $t -r $r $delta  -I 2 13 17 -ej $TS 1 2  -n 1 $N1 -n 2 $N2   -m  1 2  $M12  -m  2 1  $M21 >line
   ./fastSimBac 30 $L -T -t $t -r $r $delta  -I 2 13 17 -ej $TS 1 2  -n 1 $N1 -n 2 $N2   -m  1 2  $M12  -m  2 1  $M21  | ./msformatter >temp2 
if test -s temp2
then 
echo "temp2" >>log
cat  line temp2  >> $i.ms

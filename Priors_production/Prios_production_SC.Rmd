...
for (i in 1:10000){#tirage des priors demographiques
  ...
  m_demo=matrix(c(Ts,N1,N2,Na,M12,M21,Tsc),ncol=7)
  m_demo=as.data.frame(m_demo)
  locus<-cbind(m_locus,m_demo)
    path <- "/home/kadurand/partage_windows/Xylella/analyses_genomiques/ABC/fastSimBac_linux/Priors_SC_10000/PriorsSC-"

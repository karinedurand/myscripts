...
## importe un fasta
dna <- read.dna(file = "/home/dmerda/Bureau/Documents/analyses_genomique/analyse_X.arboricola_sens_strict/finestructure_AB_mauve/alignement_AB.fasta", format="fasta", as.character = "TRUE", as.matrix="TRUE")
## find SNPS
...
for (i in 1:nrow(snp)){
  new=snp[i,]
  cat(paste(">",rownames(snp)[i],sep="",collapse=""), "\n", file="/home/dmerda/Bureau/Documents/analyses_genomique/analyse_X.arboricola_sens_strict/finestructure_AB_mauve/snpAB.fa", append=T)
...
SNPfile <- read.dna(file = "/home/dmerda/Bureau/Documents/analyses_genomique/analyse_X.arboricola_sens_strict/finestructure_ABC/core_genome_ABC_renomme_Nogap4.fasta", format="fasta", as.character = "TRUE", as.matrix="TRUE")
...
for (i in 1:nrow(SNP_no_recombi)){
  ...
  cat(paste(">",rownames(SNP_no_recombi)[i],sep="",collapse=""), "\n", file="/home/dmerda/Bureau/Documents/analyses_genomique/analyse_X.arboricola_sens_strict/finestructure_ABC/core_genome_ABC_renomme_Nogap_forSNP.fasta", append=T)
  cat(paste(new,sep="",collapse=""), "\n", file="/home/dmerda/Bureau/Documents/analyses_genomique/analyse_X.arboricola_sens_strict/finestructure_ABC/core_genome_ABC_renomme_Nogap_forSNP.fasta", append=T)
}

...
extract.tracts(alignment, recBlocks, consTree, "/home/kadurand/partage_windows/Xylella/analyses_genomiques/Tip-dating/clonalframe/trecombinant_tracts.fasta")  # mettre le chemin pour le fichier de sortie + mettre un nom 

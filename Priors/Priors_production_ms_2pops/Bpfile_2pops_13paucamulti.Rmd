...
t<-c(rep(0.081407,997))
r<-c(rep(0.081407,997))
nspA<-c(rep(13, 997))
nspB<-c(rep(17, 997))
...
write.table(bpfile,file= "/home//kadurand/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/bpfile_theta",col.names=FALSE,row.names =FALSE)
}
```

...
t<-runif(997,0, 0.0003 )#bound_theta=[0-0.0003]bornes vrai pour 13pauca_multiplex augmenter la borne sup à 0.001]
r<-runif(997,0,0.0003)#bound_rho=[0-0.0003]bornes vrai pour 13pauca_multiplex augmenter la borne sup à 0.001]
...
for (i in 1:1000){#tirage des priors demographiques
  ...
  M12<-runif(1,0,30)#bound=[0.01-30]
  M21<-runif(1,0,30)#bound=[0.01-30]
...
path <- "/home//kadurand/partage_windows/Xylella/analyses_genomiques/ABC/msms/Priors_IM_ms_13/IM" 

...
#L<-scan("/home/ka   ")#bound_taille du gene[100-2500]
L<-scan("/home/kadurand/partage_windows/Xylella/analyses_genomiques/ABC/myscripts/Priors_production_ms_3pops/length_3pops")#bound_taille du gene[100-2500]
...
#Param_demo (3) =   Ts, N1, N2,
  Ts1<-runif(1,0,1000)#bound=[1,100,1E+8]
  Ts2<-runif(1,0,Ts1)#bound=[1,100,1E+7] Ts/4N0
  N1<-runif(1,0,1E+3)#bound=[100,1E+6] X=N1/N0
  N2<-runif(1,0,1E+3)#bound=[100,1E+6]
  N3<-runif(1,0,1E+3)#bound=[100,1E+6]
  Na<-runif(1,0,1E+3)#Bound=[100,1E+6]
  
#print( N1, N2, Ts)
m_demo=matrix(c(Ts1,Ts2,N1,N2,N3,Na),ncol=6)
m_demo=as.data.frame(m_demo)
locus<-cbind(m_locus,m_demo)

path <- "/home//kadurand/partage_windows/Xylella/analyses_genomiques/ABC/msms/3pops_19paucamulti/Priors_SI_A_3pops/SI_A" 

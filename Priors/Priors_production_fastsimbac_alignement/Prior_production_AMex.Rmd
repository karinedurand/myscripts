---
title: "Priors_production_AMex.Rmd"
...
N2<-rlunif(1,100,100000)#bound=[100-100000]
  ...
  Tam<-rlunif(1,100,10000000)#)#bound=[0-100]
  Te<-rlunif(1,10,10000000)#)#bound=[0-100]
  ex<-runif(1,0.0001,10000)#)#bound=[0-1]
  #print( Ts , N1, N2,  M12, M21,Tam)
m_demo=matrix(c(Ts,N1,N2,M12,M21,Tam,Te,ex),ncol=8)
m_demo=as.data.frame(m_demo)
locus<-cbind(m_locus,m_demo)

path <- "/home//kadurand/partage_windows/Xylella/analyses_genomiques/ABC/fastSimBac_linux/Priors_AMex_10000/locus" 

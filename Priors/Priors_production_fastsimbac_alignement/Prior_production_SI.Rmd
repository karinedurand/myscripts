...
m_demo=matrix(c(N1,N2,Ts),ncol=3)
m_demo=as.data.frame(m_demo)
locusSI<-cbind(m_locus,m_demo)
...
write.table(locusSI,file= "/home//kadurand/partage_windows/Xylella/analyses_genomiques/ABC/fastSimBac_linux/fastsimbac_alignement_13paucacvcmulti/locusSI",col.names=FALSE,row.names =FALSE)
```

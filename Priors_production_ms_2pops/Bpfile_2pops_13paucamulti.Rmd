...
write.table(bpfile,file= "/home//kadurand/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/bpfile_13paucamulti.txt",col.names=FALSE,row.names =FALSE)
}
```

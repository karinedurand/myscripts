...
t<-runif(997,0, 0.003 )#bound_theta=[0-0.0003]bornes vrai pour 13pauca_multiplex augmenter la borne sup à 0.001]
r<-runif(997,0,0.003)#bound_rho=[0-0.0003]bornes vrai pour 13pauca_multiplex augmenter la borne sup à 0.001]
...
for (i in 1:1000){#tirage des priors demographiques
  ...
  Ts<-runif(1,0,100)#bound=[1,100,1E+7] Ts/4N0
  N1<-runif(1,0,50)#bound=[100,1E+6] X=N1/N0
  N2<-runif(1,0,50)#bound=[100,1E+6]
  Na<-runif(1,0,100)#Bound=[100,1E+6]
...
path <- "/home//kadurand/partage_windows/Xylella/analyses_genomiques/ABC/msms/Priors_IM_ms_/IM" 

...
t<-runif(997,0, 0.004 )#bound_theta=[0-0.0003]bornes vrai pour 13pauca_multiplex augmenter la borne sup à 0.001]
r<-runif(997,0,0.004)#bound_rho=[0-0.0003]bornes vrai pour 13pauca_multiplex augmenter la borne sup à 0.001]
...
path <- "/home//kadurand/partage_windows/Xylella/analyses_genomiques/ABC/msms/Priors_SI_ms_13/SI" 

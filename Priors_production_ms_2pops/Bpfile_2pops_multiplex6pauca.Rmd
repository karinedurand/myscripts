...
L<-scan("/home/kadurand/partage_windows/Xylella/analyses_genomiques/ABC/obs/1169_17multiplex6st53/lenght1169")#bound_taille du gene[100-2500]
...
t<-c(rep(0.00162814,1169))
r<-c(rep(0.00162814,1169))
nspA<-c(rep(17, 1169))
nspB<-c(rep(6, 1169))
#delta<-round(runif(997,10, 1000))#bound=[10-1000]
#print(L,t,r,delta)
rbind(L,nspA,nspB,t*L,r*L)->bpfile



path <- "/home//kadurand/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_19pauca//" 
write.table(bpfile,file= "/home//kadurand/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_multi_6paucast53/bpfile_6paucamulti",col.names=FALSE,row.names =FALSE)
}
```

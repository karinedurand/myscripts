...
write.table(bpfile,file= "/home//kadurand/partage_windows/Xylella/analyses_genomiques/ABC/priorgen_13paucamulti/bpfile_2pauca",col.names=FALSE,row.names =FALSE)
}
```

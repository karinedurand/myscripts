...
echo ./fastSimBac 30 $L  -t $t -r $r $delta  -I 3 6 13 17 0  -n 1 $N1 -n 2 $N2 -n 3 $N3 -es Ta 2 p2 -ej Ta 2 1 -ej Ta 4 3 -ej TS 3 1
  >line
   fastSimBac 30 $L  -t $t -r $r $delta  -I 3 6 13 17 0  -n 1 $N1 -n 2 $N2 -n 3 $N3 -es Ta 2 p2 -ej Ta 2 1 -ej Ta 4 3 -ej TS 3 1 | msformatter >temp2 
if test -s temp2
then 
echo "temp2" >>log
cat  line temp2  >> $i.ms

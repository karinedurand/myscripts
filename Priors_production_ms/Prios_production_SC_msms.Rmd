...
#print(L,t,r,delta)
m_locus=matrix(c(L,t*L,r*L,delta),ncol=4)
...
for (i in 1:1000){#tirage des priors demographiques
  ...
  Tsc<-rlunif(1,10,1E+5)#bound=[0-100]borne sup <Ts
  ...
  locus<-cbind(m_locus,m_demo)
    path <- "/home/kadurand/partage_windows/Xylella/analyses_genomiques/ABC/msms/Priors_SC_msms_mod/SC"
